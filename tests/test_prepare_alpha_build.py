...
class PrepareAlphaBuildTests(unittest.TestCase):
    ...
    def test_local_builder_plan_contains_clean_native_regeneration_and_standalone_release_steps(self):
        ...
        self.assertIn("assembleRelease", flattened)
        self.assertNotIn("assembleDebug", flattened)
